...
if (isset($_POST['submit']) && !empty($_POST['email'])) {
    ...
    $query = $db->query("SELECT email, username FROM tbl_super_admins WHERE email = '$email' UNION ALL SELECT email, username FROM tbl_deans WHERE email = '$email' UNION ALL SELECT email, username FROM tbl_admissions WHERE email = '$email' UNION ALL SELECT email, username FROM tbl_accounting WHERE email = '$email' UNION ALL SELECT email, username FROM tbl_admins WHERE email = '$email' UNION ALL SELECT email, username FROM tbl_faculties WHERE email = '$email' UNION ALL SELECT email, username FROM tbl_students WHERE email = '$email' UNION ALL SELECT email, username FROM tbl_presidents WHERE email = '$email'  UNION ALL SELECT email, username FROM tbl_faculties_staff WHERE email = '$email' UNION ALL SELECT email, username FROM tbl_guidances WHERE email = '$email'");
